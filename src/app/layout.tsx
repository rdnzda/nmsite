  ...
  return (
    <html lang="en" className={[inter.variable, calSans.variable].join(" ")}>
      <body className={`bg-black ${process.env.NODE_ENV === "development" ? "debug-screens" : ""}`}>
        <main className="main-container flex flex-col items-center justify-center min-w-full overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black relative">
